...
<div class="row">
    ...
    <div class="col-md-3 text-center">
        <img src="../foto_produk/<?php echo $value["nama_produk_foto"] ?>" alt="" class="img-fluid mb-3"><br>
        <a href="index.php?halaman=hapusfotoproduk&idfoto=<?php echo $value["id_produk_foto"] ?>&idproduk=<?php echo $id_produk ?>" class="btn btn-danger btn-sm mb-5">Hapus</a>
    </div>
    <?php endforeach ?>
</div>
...
<form method="post" enctype="multipart/form-data">
    ...
    <button class="btn btn-primary mb-5" name="simpan" value="simpan">Simpan</button>
</form>
